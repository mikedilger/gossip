...
pub struct Nip05V1 {
    ...
    #[serde(default)]
    pub relays: HashMap<PublicKeyHex, IndexSet<UncheckedUrl>>,
}
...
impl Nip05V1 {
    ...
    pub(crate) fn mock() -> Nip05V1 {
        ...
        let mut relays: HashMap<PublicKeyHex, IndexSet<UncheckedUrl>> = HashMap::new();
        let _ = relays.insert(
            pubkey,
            IndexSet::from([
...
mod test {
  ...
  "relays": {
    "b0635d6a9851d3aed0cd6c495b282167acf761729078d975fc341b22650b07b9": [ "wss://relay.example.com", "wss://relay2.example.com" ]
        ...
        let bobs_relays: IndexSet<UncheckedUrl> = nip05.relays.get(&bobs_pk).unwrap().to_owned();
